...
<p align="center">
  ...
  <h3 align="center">Template Frintezza Basic</h3>
</p>
...
2. Depois do projeto criado você pode deletar o arquivo `App.js` (com o comando: `rm ./App.js`) da raiz, pois o arquivo `index.js` agora aponta para a pasta **src**.
